 ...
 *
 *  after creating the parser, call exactly one parsing method depending on the expected concept
 */
class Parser(input: String) {
  ...
  // *********************** low-level parsing function that actually inspects the input
