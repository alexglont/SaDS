...
case class ProductType(x : Type, y : Type) extends Type
...
/** AM Terms of Product Type: Pair*/
case class Pair(first : Term, second : Term) extends Term

/** AM Terms formed from Pairs: Projection*/
case class Projection(x : Term) extends Term
